...
@section('content')
	...
	<div class="search-result">
		...
		<ul class="nav nav-tabs nav-tabs-v2 px-2 small text-uppercase" role="tablist">
			<li class="nav-item me-4" role="presentation"><a href="#tab1" class="nav-link active px-2 py-2" data-bs-toggle="tab">Explore</a></li>
			<li class="nav-item me-4" role="presentation"><a href="#tab2" class="nav-link px-2 py-2" data-bs-toggle="tab">Accessories</a></li>
			<li class="nav-item me-4" role="presentation"><a href="#tab3" class="nav-link px-2 py-2" data-bs-toggle="tab">Support</a></li>
			<li class="nav-item me-4" role="presentation"><a href="#tab4" class="nav-link px-2 py-2" data-bs-toggle="tab">Store</a></li>
		</ul>
