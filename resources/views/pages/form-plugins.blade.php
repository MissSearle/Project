							...
							<form id="fileupload" action="//jquery-file-upload.appspot.com/" name="file_upload_form" method="POST" enctype="multipart/form-data">
								...
								<div class="card-header with-btn">
									...
									<div class="card-body p-0">
										<table class="table table-card mb-0 fs-10px">
											<thead>
												<tr>
											...
											<tbody class="files">
												<tr class="empty-row">
													<td colspan="4" class="text-center p-3">
														<div class="text-white text-opacity-30 d-flex justify-content-center mb-1"><iconify-icon class="fa-3x" icon="material-symbols-light:upload-file-outline-sharp"></iconify-icon></div> 
														No file uploaded
													</td>
												</tr>
											</tbody>
...
<img src="/assets/img/gallery/gallery-1.jpg" alt="" width="283" class="float-start me-3 mb-3">
<div>
...
<hr>
<div class="clearfix pt-3 pb-3">
<img src="/assets/img/gallery/gallery-2.jpg" alt="" width="283" class="float-end ms-3 mb-3">
<div>
	...
	{% for (var i=0, file; file=o.files[i]; i++) { %}
		<tr class="template-upload">
			...
			<td>
				...
				<div class="progress progress-sm mb-0 h-4px progress-striped active"><div class="progress-bar progress-bar-primary" style="min-width: 2em; width:0%;"></div></div>
			</td>
			<td nowrap>
