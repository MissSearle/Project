...
@section('content')
	...
	<div class="card">
		...
		<div class="card-body">
			<p>
				Add the following code for mixed nav with boxed layout page setting. 
			</p>
		</div>
		<div class="hljs-container">
			<pre><code class="php" data-url="/assets/data/layout-mixed-nav-boxed-layout/code-1.json"></code></pre>
		</div>
	</div>
@endsection
