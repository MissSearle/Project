						...
						<div id="checkboxes" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row mb-n3">
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-2"><b class="fw-bold">DEFAULT CHECKBOX</b></div>
										...
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-2"><b class="fw-bold">INLINE CHECKBOX</b></div>
											<div class="form-group mb-3">
						...
						<div id="radios" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row mb-n3">
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-2"><b class="fw-bold">DEFAULT RADIO</b></div>
											<div class="form-group mb-4">
												<div class="form-check">
										...
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-2"><b class="fw-bold">INLINE RADIO</b></div>
											<div class="form-group mb-3">
												<div class="form-check form-check-inline">
						...
						<div id="selectMenu" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-2"><b class="fw-bold">DEFAULT</b></div>
										...
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-2"><b class="fw-bold">SIZING</b></div>
											<select class="form-select form-select-lg mb-3">
												<option selected>Open this select menu</option>
												<option value="1">One</option>
												<option value="2">Two</option>
