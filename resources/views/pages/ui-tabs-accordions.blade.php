							...
							<div class="card">
								...
								<div class="card-body pt-1">
									...
									<ul class="nav nav-tabs nav-tabs-v2">
										<li class="nav-item mx-3"><a href="#homev2" class="nav-link active py-2" data-bs-toggle="tab">Home</a></li>
										<li class="nav-item mx-3"><a href="#profilev2" class="nav-link py-2" data-bs-toggle="tab">Profile</a></li>
