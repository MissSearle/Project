						...
						<div id="chartJsLineChart" class="mb-5">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="h-250px"><canvas id="lineChart" class="h-100 w-100"></canvas></div>
								</div>
						...
						<div id="chartJsBarChart" class="mb-5">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="h-250px"><canvas id="barChart" class="h-100 w-100"></canvas></div>
								</div>
								<div class="hljs-container">
						...
						<div id="chartJsRadarChart" class="mb-5">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="h-250px"><canvas id="radarChart" class="h-100 w-100"></canvas></div>
								</div>
								<div class="hljs-container">
						...
						<div id="chartJsPolarAreaChart" class="mb-5">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="h-250px"><canvas id="polarAreaChart" class="h-100 w-100"></canvas></div>
								</div>
								<div class="hljs-container">
						...
						<div id="chartJsPieChart" class="mb-5">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="h-250px"><canvas id="pieChart" class="h-100 w-100"></canvas></div>
								</div>
								<div class="hljs-container">
						...
						<div id="chartJsDoughnutChart" class="mb-5">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="h-250px"><canvas id="doughnutChart" class="h-100 w-100"></canvas></div>
								</div>
								<div class="hljs-container">
