								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-xl-6">
											...
											<div class="card mb-3">
												<div class="card-header">
													<ul class="nav nav-pills card-header-pills fw-semibold">
														<li class="nav-item">
															<a class="nav-link active" href="#">ACTIVE</a>
														</li>
														<li class="nav-item">
										...
										<div class="col-xl-6">
											...
											<div class="card mb-3">
												...
												<div class="card-body">
													...
													<p class="card-text"><small class="text-body text-opacity-50">Last updated 3 mins ago</small></p>
												</div>
											</div>
										</div>
										<div class="col-xl-6">
											...
											<div class="card mb-3">
												<img src="https://placehold.co/600x600/051016/ffffff" alt="" class="card-img" />
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row gx-0 align-items-center">
										<div class="col-md-3">
											<img src="https://placehold.co/480x360/c9d2e3/212837" alt="" class="card-img">
										</div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="card mb-3">
												<div class="card-header bg-theme bg-opacity-15">HEADER</div>
												<div class="card-body bg-theme bg-opacity-30 text-white">
										...
										<div class="col-xl-6">
											...
											<div class="card mb-3">
												<div class="card-header text-theme">HEADER</div>
												<div class="card-body">
