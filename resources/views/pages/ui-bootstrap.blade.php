					...
					<div class="col-xl-9">
						...
						<div id="badge" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<div>
										<span class="badge bg-primary bg-opacity-10 text-primary border border-primary">Primary</span>
										<span class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary">Secondary</span>
										<span class="badge bg-success bg-opacity-10 text-success border border-success">Success</span>
										<span class="badge bg-danger bg-opacity-10 text-danger border border-danger">Danger</span>
										<span class="badge bg-warning bg-opacity-10 text-warning border border-warning">Warning</span>
										<span class="badge bg-info bg-opacity-10 text-info border border-info">Info</span>
										<span class="badge bg-light bg-opacity-10 text-light border border-light">Light</span>
										<span class="badge bg-dark bg-opacity-10 text-dark border border-dark">Dark</span>
									</div>
								</div>
								<div class="hljs-container">
									...
									<div id="carouselExample" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="carousel-item active">
												<img src="https://placehold.co/728x400/051016/ffffff" alt="" class="d-block w-100">
												<div class="carousel-caption d-none d-md-block">
													<h5>First slide label</h5>
													<p class="text-body text-opacity-50">Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
												</div>
											</div>
											<div class="carousel-item">
												...
												<div class="carousel-caption d-none d-md-block">
													...
													<p class="text-body text-opacity-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
												</div>
											</div>
											<div class="carousel-item">
												<img src="https://placehold.co/728x400/051016/ffffff" alt="" class="d-block w-100">
												<div class="carousel-caption d-none d-md-block">
													...
													<p class="text-body text-opacity-50">Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
												</div>
											</div>
										</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="d-flex align-items-start">
										<img src="https://placehold.co/128x128/051016/ffffff" alt="" width="64" />
										<div class="ms-3">
						...
						<div id="navbar" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<nav class="navbar navbar-expand-lg bg-white bg-opacity-10 mb-3" id="navbarLight">
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbarLight">
												...
												<form class="d-flex">
													...
													<button class="btn btn-theme my-2 my-sm-0" type="submit">SEARCH</button>
												</form>
											</div>
										</div>
									</nav>
									<nav class="navbar navbar-expand-lg bg-black bg-opacity-50" id="navbarDark">
										<div class="container-fluid">
