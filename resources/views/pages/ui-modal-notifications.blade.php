					...
					<div class="col-xl-9">
						...
						<div id="modalSizes" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<!-- modal-xl -->
									<button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#modalXl">Extra large modal</button>
									
									<!-- modal-lg -->
									<button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#modalLg">Large modal</button>
									
									<!-- modal-sm -->
									<button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#modalSm">Small modal</button>
								</div>
								<div class="hljs-container">
						...
						<div id="modalCover" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<!-- modal-cover -->
									<button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#modalCoverExample">Modal Cover</button>
								</div>
								<div class="hljs-container">
						...
						<div id="toastsContainer" class="mb-5">
							...
							<div class="card">
								...
								<div class="card-body">
									<a href="#" class="btn btn-theme me-2" data-toggle="toast" data-target="#toast-1">Show toast 1</a>
									<a href="#" class="btn btn-theme" data-toggle="toast" data-target="#toast-2">Show toast 2</a>
								</div>
								<div class="hljs-container">
